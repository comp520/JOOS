...
public final class AFinalExternMethodmods extends PExternMethodmods
{
    private TFinal _final_;

    public AFinalExternMethodmods()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFinalExternMethodmods(
    ...
    {
        ((Analysis) sw).caseAFinalExternMethodmods(this);
    }
